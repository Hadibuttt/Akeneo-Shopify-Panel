                                        ...
                                        <div>
                                            <div class="Polaris-Tabs__Wrapper_mkrm3 Polaris-Tabs--newDesignLanguage_1rik8">
                                                <ul role="tablist" class="Polaris-Tabs_yjc8o Polaris-Tabs--fillSpace_yc42y Polaris-Tabs--newDesignLanguage_1rik8">
                                                    ...
                                                    <li class="Polaris-Tabs__TabContainer_dsj6d Polaris-Tabs--newDesignLanguage_1rik8" role="presentation"><a data-polaris-unstyled="true" id="unfulfilled" role="tab" tabindex="-1" class="Polaris-Tabs__Tab_375k2 Polaris-Tabs__Tab--selected_11sap" aria-selected="false" aria-controls="unfulfilled-panel" aria-label="Unfulfilled" href="/admin/orders?selectedView=unfulfilled&amp;fulfillment_status=unshipped%2Cpartial&amp;status=open"><span class="Polaris-Tabs__Title_2qj8j Polaris-Tabs--newDesignLanguage_1rik8">Unfulfilled</span></a></li>
                                                    <li class="Polaris-Tabs__TabContainer_dsj6d Polaris-Tabs--newDesignLanguage_1rik8" role="presentation"><a data-polaris-unstyled="true" id="unpaid" role="tab" tabindex="-1" class="Polaris-Tabs__Tab_375k2 Polaris-Tabs__Tab--selected_11sap" aria-selected="false" aria-controls="unpaid-panel" aria-label="Unpaid" href="/admin/orders?selectedView=unpaid&amp;status=open&amp;financial_status=unpaid"><span class="Polaris-Tabs__Title_2qj8j Polaris-Tabs--newDesignLanguage_1rik8">Unpaid</span></a></li>
                                                    <li class="Polaris-Tabs__TabContainer_dsj6d Polaris-Tabs--newDesignLanguage_1rik8" role="presentation"><a data-polaris-unstyled="true" id="open" role="tab" tabindex="-1" class="Polaris-Tabs__Tab_375k2 Polaris-Tabs__Tab--selected_11sap" aria-selected="false" aria-controls="open-panel" aria-label="Open" href="/admin/orders?selectedView=open&amp;status=open"><span class="Polaris-Tabs__Title_2qj8j Polaris-Tabs--newDesignLanguage_1rik8">Open</span></a></li>
                                                    <li class="Polaris-Tabs__TabContainer_dsj6d Polaris-Tabs--newDesignLanguage_1rik8" role="presentation"><a data-polaris-unstyled="true" id="closed" role="tab" tabindex="-1" class="Polaris-Tabs__Tab_375k2 Polaris-Tabs__Tab--selected_11sap" aria-selected="false" aria-controls="closed-panel" aria-label="Closed" href="/admin/orders?selectedView=closed&amp;status=closed&amp;sortKey=PROCESSED_AT"><span class="Polaris-Tabs__Title_2qj8j Polaris-Tabs--newDesignLanguage_1rik8">Closed</span></a></li>
...
@if ($order_detail->order_id == $order->id)
           ...
           @if ($order_item->order_id == $order->id)
                        ...
                        @endforeach
                                                    ...
                                                    <td class="_2ROf4"><span class=""><span>Standard shipping</span></span></td>
                                                    <td class="_2ROf4">
