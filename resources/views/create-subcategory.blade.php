...
<main class="Polaris-Frame__Main_yj28s Polaris-Frame__Main--newDesignLanguage_129jf" id="AppFrameMain" data-has-global-ribbon="false"><a id="AppFrameMainContent" tabindex="-1"></a>
    <div class="Polaris-Frame__Content_xd1mk">
        ...
        @endforeach
                            ...
                            <div class="Polaris-Card_yis1o Polaris-Card--newDesignLanguage_1rik8">
                                ...
                                <div class="Polaris-Card__Section_1b1h1">
                                    <p>Add a title and description to see how this sub-category might appear in a search engine listing</p>
                                </div>
                                <div class="Polaris-Card__Section_1b1h1">
                                    <div class="Polaris-FormLayout_1wntl">
                                        <div class="Polaris-FormLayout__Item_yiyol">
    ...
    <input name="SEOtitle" type="text" placeholder="" class="Polaris-TextField__Input_30ock" aria-describedby="PolarisTextField18HelpText" aria-labelledby="PolarisTextField18Label" aria-invalid="false" aria-multiline="false">
                                                ...
                                                <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                    <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                        <div class="Polaris-TextField_1spwi Polaris-TextField--multiline_1jgfe Polaris-TextField--newDesignLanguage_1rik8">
                                                            ...
                                                            <textarea name="SEOdescription" placeholder="" class="Polaris-TextField__Input_30ock" aria-describedby="PolarisTextField19HelpText" aria-labelledby="PolarisTextField19Label" aria-invalid="false" aria-multiline="true" style="height: 108px;"></textarea>
                                                ...
                                                <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                    <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                        <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                                            ...
                                                            <input name="handle" type="text" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField20Label PolarisTextField20Prefix" aria-invalid="false" aria-multiline="false" value="">
                                ...
                                <header class="_1UFNz">
                                    <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentBaseline_aupj5">
                                        <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">
                                            <h2 class="Polaris-Heading_1brcv">Sub-Category Image</h2>
                                        </div>
                                    </div>
                                </header>
                                <div class="Polaris-Card__Section_1b1h1">
                        ...
                        <div class="Polaris-Layout__Section_1b1h1">
                            <div class="Polaris-PageActions_fcnua">
                                <div class="Polaris-Stack_32wu2 Polaris-Stack--spacingTight_1o4d6 Polaris-Stack--distributionTrailing_z5d5z">
                                    <div class="Polaris-Stack__Item_yiyol"><button class="Polaris-Button_r99lw Polaris-Button--newDesignLanguage_1rik8 Polaris-Button--primary_7k9zs" href="{{route('addsubcat')}}" type="submit"><span class="Polaris-Button__Content_xd1mk"><span class="Polaris-Button__Text_yj3uv">Save</span></span></button></div>
                                </div>
                            </div>
                        </div>
