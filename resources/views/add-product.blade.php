...
<div class="Polaris-Frame__ContextualSaveBar Polaris-Frame-CSSAnimation--startFade" ></div>
                    ...
                    <div class="Polaris-Card">
                        <div class="Polaris-Card__Section">
                            ...
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px; margin-top: 30px;">
                              <p class="Polaris-DisplayText Polaris-DisplayText--sizeSmall">Description</p>
                            </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <div class="">
                                <div class="Polaris-Connected">
  ...
  <div class="Polaris-Labelled--hidden">
    ...
    <div class="Polaris-DropZone Polaris-DropZone--hasOutline Polaris-DropZone--sizeExtraLarge" aria-disabled="false">
          ...
          <div class="Polaris-Stack Polaris-Stack--vertical">
            ...
            <div class="Polaris-Stack__Item"><span class="Polaris-TextStyle--variationSubdued">or drop files to upload</span></div>
                    ...
                    <div class="Polaris-Card">
                        ...
                        <div class="Polaris-Card__Header p-0">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-lg-6 col-md-6 col-sm-6 mt-5">
                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Sell Price</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <div class="">
                                <div class="Polaris-Connected">
                            ...
                            <div class=" col-lg-6 col-md-6 col-sm-6 mt-5">
                                 <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Sale Price</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <div class="">
                                <div class="Polaris-Connected">
                        ...
                        <div class="row">
                            <div class=" col-lg-6 col-md-6 col-sm-6 mt-5">
                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Assign Price</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <div class="">
                                <div class="Polaris-Connected">
                            ...
                            <div class=" col-lg-6 col-md-6 col-sm-6 mt-5">
                                 <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Tax in %</h3>
                                </div>
                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                  <div class="">
                                    <div class="Polaris-Connected">
                    ...
                    <div class="Polaris-Card">
                        ...
                        <div class="Polaris-Card__Header p-0">
                            <h2 class="Polaris-Heading">Search Engine listing preview</h2>
                        </div>
                           <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Use specific words to make it apear in the top of the list</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <p class="Polaris-DisplayText Polaris-DisplayText--sizeSmall">Title</p>
                            </div>
                            ...
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <p class="Polaris-DisplayText Polaris-DisplayText--sizeSmall mt-5">URL and handle</p>
                            </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                              <div class="">
                                <div class="Polaris-Connected">
                                  <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                    <div class="Polaris-TextField Polaris-TextField--hasValue"><input id="PolarisTextField10" class="Polaris-TextField__Input" aria-labelledby="PolarisTextField10Label" aria-invalid="false" aria-multiline="false" placeholder="http://www.abc.com.pk">
                                      <div class="Polaris-TextField__Backdrop"></div>
                                    </div>
                                  </div>
                                </div>
      ...
      <div class="Polaris-FormLayout" style="margin-bottom: 30px;">
...
<div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
        <div class="Polaris-Banner Polaris-Banner--statusInfo Polaris-Banner--hasDismiss Polaris-Banner--withinPage" tabindex="0" role="status" aria-live="polite" aria-labelledby="PolarisBanner14Heading" aria-describedby="PolarisBanner14Content">
            ...
            <div class="Polaris-Banner__ContentWrapper">
                <div class="Polaris-Banner__Content" id="PolarisBanner14Content">
                    <p>Make sure you know how these changes affect your store.</p>
                    <div class="Polaris-Banner__Actions">
                        <div class="Polaris-ButtonGroup">
                            <div class="Polaris-ButtonGroup__Item">
                                <div class="Polaris-Banner__PrimaryAction"><button type="button" class="Polaris-Button Polaris-Button--outline"><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Learn more</span></span></button></div>
                            </div>
                        </div>
                    </div>
                </div>
              ...
              <path d="M8.315 13.859l-3.182-3.417a.506.506 0 0 1 0-.684l.643-.683a.437.437 0 0 1 .642 0l2.22 2.393 4.942-5.327a.436.436 0 0 1 .643 0l.643.684a.504.504 0 0 1 0 .683l-5.91 6.35a.437.437 0 0 1-.642 0"></path>
            </svg></span></span></span></span><span class="Polaris-Choice__Label">This product have different option like different sizes or color.</span></label></div>
                       ...
                       <div class="Polaris-Card">
                        <div class="Polaris-Card__Header">
                            <h2 class="Polaris-Heading">Category</h2>
                        </div>
   ...
   window.location.href = window.location.href+'?c='+'<?php echo $c;?>'+'&s='+'<?php echo $s;?>'+'&cl='+collection;
                       ...
                       <div class="Polaris-Card">
                        ...
                        <div class="Polaris-Card__Section">
                                ...
                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Weight</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;margin-bottom:30px">
                              <div class="">
                                <div class="Polaris-Connected">
                                  <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                ...
                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Dimension</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;margin-bottom:30px">
                              <div class="">
                                <div class="Polaris-Connected">
                                  <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                    <div class="Polaris-TextField Polaris-TextField--hasValue"><input id="PolarisTextField10" class="Polaris-TextField__Input" aria-labelledby="PolarisTextField10Label" aria-invalid="false" aria-multiline="false" placeholder="3D,2D,etc">
                                      <div class="Polaris-TextField__Backdrop"></div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                <h3 aria-label="Accounts" class=" mb-4">Barcode</h3>
                                </div>
                            <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;margin-bottom:30px">
                              <div class="">
                                <div class="Polaris-Connected">
