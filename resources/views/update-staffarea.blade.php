                                                ...
                                                <div class="Polaris-Header-Title__TitleAndSubtitleWrapper_40sxf">
                                                    <div class="Polaris-Header-Title__TitleWithMetadataWrapper_pdqv7 Polaris-Header-Title--newDesignLanguage_1rik8">
                                                        <div class="Polaris-Header-Title_2qj8j">
                                                            <h1 class="Polaris-Header-Title--newDesignLanguageTitle_1wh8d">Update Staff Accounts</h1>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input name="f_name" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false" value="{{$user->f_name}}">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input name="l_name" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false" value="{{$user->l_name}}">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input name="password" id="InventoryCardBarcode" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardBarcodeLabel" aria-invalid="false" aria-multiline="false" value="{{$user->password}}">
                     ...
                     <div style="width: 33%; display:inline-block;float: left;">
                        <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            ...
                            <input name="OrderPage" value="1" 
                            @if ($user->OrderPage == 1) checked @endif type="checkbox" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()">
                        ...
                        <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" @if ($user->OrderDetailsPage == 1) checked @endif name="OrderDetailsPage" value="1" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Order Details</span></label>
                        ...
                        <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            ...
                            <input name="ProductPage" @if ($user->ProductPage == 1) checked @endif type="checkbox" value="1" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()">
                         ...
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            ...
                            <input type="checkbox" @if ($user->AddProductPage == 1) checked @endif value="1" name="AddProductPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Add Product</span></label>

                        </div> <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                             
                            <input type="hidden" value="0" name="UpdateProductPage">
                            <input type="checkbox" value="1" @if ($user->UpdateProductPage == 1) checked @endif name="UpdateProductPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Update Product</span></label>
                        ...
                        <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->GeneralPage == 1) checked @endif name="GeneralPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">General</span></label>
                           ...
                           <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->StaffAccountPage == 1) checked @endif name="StaffAccountPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Staff Accounts</span></label>
                     ...
                     <div style="width: 33%; display:inline-block;float: left;">
                       <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            ...
                            <input type="checkbox" value="1" @if ($user->CategoryPage == 1) checked @endif name="CategoryPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Category</span></label>

                        </div> <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            
                            <input type="hidden" value="0" name="AddCategoryPage">
                            <input type="checkbox" value="1" @if ($user->AddCategoryPage == 1) checked @endif name="AddCategoryPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Add Category</span></label>

                        </div> <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            
                            <input type="hidden" value="0" name="UpdateCategoryPage">
                            <input type="checkbox" value="1" @if ($user->UpdateCategoryPage == 1) checked @endif name="UpdateCategoryPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Update Category</span></label>
                        ...
                        <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->CustomerPage == 1) checked @endif name="CustomerPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Customers</span></label>
                        ...
                        <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->AboutCustomerPage == 1) checked @endif name="AboutCustomerPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">About Customers</span></label>
                           ...
                           <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->SettingsPage == 1) checked @endif name="SettingsPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Settings</span></label>
                           ...
                           <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->StaffAreaPage == 1) checked @endif name="StaffAreaPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Add Staff Accounts</span></label>
                     ...
                     <div style="width: 33%; display:inline-block;">
                      <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            ...
                            <input type="checkbox" value="1" @if ($user->SubcategoryPage == 1) checked @endif name="SubcategoryPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Subcategory</span></label>

                        </div> <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            
                            <input type="hidden" value="0" name="AddSubcategoryPage">
                            <input type="checkbox" value="1" @if ($user->AddSubcategoryPage == 1) checked @endif name="AddSubcategoryPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Add Subcategory</span></label>

                        </div> <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            
                            <input type="hidden" value="0" name="UpdateSubcategoryPage">
                            <input type="checkbox" value="1" @if ($user->UpdateSubcategoryPage == 1) checked @endif name="UpdateSubcategoryPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Update Subcategory</span></label>

                        </div> <div>
                         <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                            
                            <input type="hidden" value="0" name="CollectionPage">
                            <input type="checkbox" value="1" @if ($user->CollectionPage == 1) checked @endif name="CollectionPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Collection</span></label>
                        ...
                        <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->AddCollectionPage == 1) checked @endif name="AddCollectionPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Add Collection</span></label>
                           ...
                           <div>
                            <label class="Polaris-Choice" for="PolarisCheckboxvarient">
                               ...
                               <input type="checkbox" value="1" @if ($user->UpdateCollectionPage == 1) checked @endif name="UpdateCollectionPage" id="varientCheckbox" style="height: 15px; width:15px; border: solid 4px;" onclick="varient()"><span class="Polaris-Choice__Label">Update Collection</span></label>
