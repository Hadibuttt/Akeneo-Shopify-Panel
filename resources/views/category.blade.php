...
<main class="Polaris-Frame__Main_yj28s Polaris-Frame__Main--newDesignLanguage_129jf" id="AppFrameMain" data-has-global-ribbon="false"><a id="AppFrameMainContent" tabindex="-1"></a>
    ...
    <input name="title" type="text" id="collectionTitleTextField" placeholder="e.g. Summer collection, Under $100, Staff picks" class="Polaris-TextField__Input_30ock" aria-labelledby="collectionTitleTextFieldLabel" aria-invalid="false" aria-multiline="false">
    ...
    <input name="SEOtitle" type="text" placeholder="" class="Polaris-TextField__Input_30ock" aria-describedby="PolarisTextField18HelpText" aria-labelledby="PolarisTextField18Label" aria-invalid="false" aria-multiline="false" value="">
    ...
    <input name="handle" type="text" id="PolarisTextField20" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField20Label PolarisTextField20Prefix" aria-invalid="false" aria-multiline="false">
                                                    ...
                                                    <div class="Polaris-DropZone-FileUpload_1fbjx Polaris-DropZone-FileUpload--newDesignLanguage_1rik8">
                                                        <div class="Polaris-Stack_32wu2 Polaris-Stack--vertical_uiuuj Polaris-Stack--spacingTight_1o4d6">
                                                            ...
                                                            <div class="Polaris-Stack__Item_yiyol">
                                                                    ...
                                                                    <center><input type="file" id="img" name="image" accept="image/*"></center>
