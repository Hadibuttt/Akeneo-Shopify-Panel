...
<div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;margin-top: 40px;">
  <div class="Polaris-Layout">
      ...
      <div class="Polaris-Layout__AnnotationWrapper">
        <div class="Polaris-Layout__Annotation">
          <div class="Polaris-TextContainer">
            <h2 class="Polaris-Heading">Base taxes</h2>
            <div class="Polaris-Layout__AnnotationDescription">
              <p>All applicable taxes for Netherland. These taxes will be used unless overrides are specified below.</p>
            </div>
          </div>
        </div>
                               ...
                               <div role="group" class="Polaris-FormLayout--grouped_17srt">
                                    <div class="Polaris-FormLayout__Items_38lvu">
                                        ...
                                        <div class="Polaris-FormLayout__Item_yiyol">
                                            ...
                                            <h2 class="Polaris-TextStyle--variationStrong">COUNTRY TAX</h2>
                                            <div class="">

                                                <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                    <div class="Polaris-Label_2vd36"><label id="InventoryCardBarcodeLabel" for="InventoryCardBarcode" class="Polaris-Label__Text_yj3uv"></label></div>
                                                </div>

                                                <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8" style="width: 40%;">
                                                    <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                        <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8"><input name="country tax" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false" value="" placeholder="%" style="text-align: right;">
                                    ...
                                    <div class="Polaris-FormLayout__Items_38lvu">
                                        ...
                                        <div class="Polaris-FormLayout__Item_yiyol">
                                            <div class="Polaris-TextContainer">
                                                ...
                                                <span class="Polaris-TextStyle--variationStrong">Tax Configuration</span>
    ...
    <div role="group" class="Polaris-FormLayout--condensed">
                                ...
                                <div role="group" class="Polaris-FormLayout--grouped_17srt" >
                                    <div class="Polaris-FormLayout__Items_38lvu" style="margin-top:0;">

                                        <div class="Polaris-FormLayout__Item_yiyol">
                                            <div class="Polaris-TextContainer">

                                                <span class="Polaris-TextStyle--variationSubdued">Digital Items</span>
      ...
      <div class="Polaris-FormLayout__Items" style="margin-top: 10px;">
        ...
        <div class="Polaris-FormLayout__Item" style="margin-top:0;">
          <div class="">
            <div class="Polaris-Connected">
              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                <div class="Polaris-TextField"><input id="PolarisTextField14" class="Polaris-TextField__Input" aria-labelledby="PolarisTextField14Label" aria-invalid="false" aria-multiline="false" value="IGST">
                  <div class="Polaris-TextField__Backdrop"></div>
                </div>
              </div>
            </div></div>
</div>
<!--<div class="Polaris-FormLayout__Item" style="width: 60%;margin-top:0;">
    <div class="">
                    <select style="width: 100%; height: 40px;font-size: 16px;padding-left: 10px;font-weight: 100; border: 1px solid #C9CCCF; border-radius: 5px;color: dimgrey;">
                        <option selected value="Compound on top of 9% federal tax">Compound on top of 9% federal tax</option>
                        <option value="added to 9% federal tax">added to 9% federal tax</option>
                        <option value="instead of 9% federal tax">instead of 9% federal tax</option>
                    </select>
    </div>
</div>-->
</div>
                                    ...
                                    <div class="Polaris-FormLayout__Items_38lvu" style="margin-top:0;">
                                        ...
                                        <div class="Polaris-FormLayout__Item_yiyol">
                                            <div class="Polaris-TextContainer">
                                                ...
                                                <span class="Polaris-TextStyle--variationSubdued">Food</span>
                                    ...
                                    <div class="Polaris-FormLayout__Items_38lvu" style="margin-top:0;">
                                        ...
                                        <div class="Polaris-FormLayout__Item_yiyol">
                                            <div class="Polaris-TextContainer">
                                                ...
                                                <span class="Polaris-TextStyle--variationSubdued">Non-Food</span>
    ...
    <div class="Polaris-FormLayout__Items_38lvu" style="margin-top:0;">
        ...
        <div class="Polaris-FormLayout__Item_yiyol">
            <div class="Polaris-TextContainer">
                ...
                <span class="Polaris-TextStyle--variationSubdued">city</span>
