...
<div class="Polaris-TextField_1spwi Polaris-TextField--hasValue_1mx8d Polaris-TextField--newDesignLanguage_1rik8">
    ...
    <input name="title" type="text" id="PolarisTextField1" value="{{$product->pro_title}}" placeholder="Short sleeve t-shirt" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField1Label" aria-invalid="false" aria-multiline="false">
        ...
        <div class="Polaris-DropZone__Container_13mbo">
            <div class="_HQ0f">
                ...
                <div class="_15Gq9">
                    ...
                    <div class="HM1EI" id="Display1" style="overflow: hidden;"><button type="button" class="_1q_T1"><span class="QfaYE"><label><input type="file"  accept="image/*" name="image" id="file1"  onchange="loadFile(event)" style="display: none;">Add Media</label></span><span class="_20LrM">or drop files to upload</span><p id="output">{{$product->pro_img}}</p></button></div>
                    
                    <div class="HM1EI"style="overflow: hidden;"><button type="button" class="_1q_T1"><span class="QfaYE"><label><input type="file" name="image2" accept="image/*" id="file2"  onchange="loadFile1(event)" style="display: none;">Add Media</label></span><span class="_20LrM">or drop files to upload<br><p id="output1">{{$product_image->pro_img2}}</p></span></button></div>
                    
                    <div class="HM1EI"style="overflow: hidden;"><button type="button" class="_1q_T1"><span class="QfaYE"><label><input type="file" name="image3" accept="image/*" id="file3"  onchange="loadFile2(event)" style="display: none;">Add Media</label></span><span class="_20LrM">or drop files to upload<br><p id="output2">{{$product_image->pro_img3}}</p></span></button></div>
                    
                    <div class="HM1EI"style="overflow: hidden;"><button type="button" class="_1q_T1"><span class="QfaYE"><label><input type="file" name="image4" accept="image/*" id="file4"  onchange="loadFile3(event)" style="display: none;">Add Media</label></span><span class="_20LrM">or drop files to upload<br><p id="output3">{{$product_image->pro_img4}}</p></span></button></div>
                    
                    <div class="HM1EI"style="overflow: hidden;"><button type="button" class="_1q_T1"><span class="QfaYE"><label><input type="file" name="image5" accept="image/*" id="file5"  onchange="loadFile4(event)" style="display: none;">Add Media</label></span><span class="_20LrM">or drop files to upload<br><p id="output4">{{$product_image->pro_img5}}</p></span></button></div>
                </div>
            </div>
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input name="sellprice" value="{{$product->pro_price}}" type="text" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false" value="">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input value="{{$product->saleprice}}" name="saleprice" type="text" id="InventoryCardBarcode" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardBarcodeLabel" aria-invalid="false" aria-multiline="false" value="">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input value="{{$product->purchaseprice}}" name="purchaseprice" type="text" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false" value="">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input value="{{$product->weight}}" name="weight" type="text" id="InventoryCardBarcode" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardBarcodeLabel" aria-invalid="false" aria-multiline="false">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input value="{{$product->dimension}}" name="dimension" type="text" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false">
                        ...
                        <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                            <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                    ...
                                    <input name="barcode" type="text" id="InventoryCardSku" class="Polaris-TextField__Input_30ock" aria-labelledby="InventoryCardSkuLabel" aria-invalid="false" aria-multiline="false" value="{{$product->barcode}}">
...
<div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
    ...
    <input name="SEOtitle" type="text" id="PolarisTextField15" placeholder="" class="Polaris-TextField__Input_30ock" aria-describedby="PolarisTextField15HelpText" aria-labelledby="PolarisTextField15Label" aria-invalid="false" aria-multiline="false" value="{{$product->SEOtitle}}">
...
<div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
    ...
    <input name="handle" type="text" id="PolarisTextField17" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField17Label PolarisTextField17Prefix" aria-invalid="false" aria-multiline="false" value="{{$product->SEOurl}}">
...
<option value="{{$product->status}}">Current Status: {{$product->status}}</option>
...
<div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
    <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
        ...
        <input name="tags" type="text" id="PolarisTextField5" value="{{$product->tags}}" autocomplete="off" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField5Label" aria-invalid="false" aria-multiline="false" value="" aria-autocomplete="list" role="combobox" autocapitalize="off" aria-expanded="false" aria-controls="Autocomplete4-disclosure" tabindex="0" aria-owns="Polarispopover15">
...
<div class="Polaris-Card__Section_1b1h1">
    ...
    <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
        <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
            ...
            <input name="stock" type="text" id="PolarisTextField5" value="{{$product->stock}}" autocomplete="off" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField5Label" aria-invalid="false" aria-multiline="false" value="" aria-autocomplete="list" role="combobox" autocapitalize="off" aria-expanded="false" aria-controls="Autocomplete4-disclosure" tabindex="0" aria-owns="Polarispopover15">
    ...
    <div class="Polaris-Card__Section_1b1h1">
        ...
        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                ...
                <input name="type" type="text" id="PolarisTextField5" value="{{$product->type}}" autocomplete="off" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField5Label" aria-invalid="false" aria-multiline="false" value="" aria-autocomplete="list" role="combobox" autocapitalize="off" aria-expanded="false" aria-controls="Autocomplete4-disclosure" tabindex="0" aria-owns="Polarispopover15">
...
<div class="Polaris-Card__Section_1b1h1">
    ...
    <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
        <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
            ...
            <input name="vendor" type="text" id="PolarisTextField5" value="{{$product->vendor}}" autocomplete="off" class="Polaris-TextField__Input_30ock" aria-labelledby="PolarisTextField5Label" aria-invalid="false" aria-multiline="false" value="" aria-autocomplete="list" role="combobox" autocapitalize="off" aria-expanded="false" aria-controls="Autocomplete4-disclosure" tabindex="0" aria-owns="Polarispopover15">
